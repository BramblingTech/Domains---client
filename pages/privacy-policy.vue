<template>
  <div class="tech-page privacy-policy">
    ...
    <div class="tech-page__content">
      <div class="container">
        ...
        <ul class="dots">
          ...
          <li><strong>Website</strong> refers to Domain Seller, accessible from &nbsp <a href="https://godaddy.com"
                                                                                         target="_blank">www.godaddy.com</a>
          </li>
        ...
        <ul class="dots">
          ...
          <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash
            ...
            objects?" available at <a target="_blank"
                                      href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_">this
              link</a>
          </li>
        ...
        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or
          ...
          Learn more about cookies: Use of Cookies by Free Privacy Policy.</p>
        ...
        <p>Your information, including Personal Data, is processed at the Company's operating offices and in any other
          ...
          governmental jurisdiction where the data protection laws may differ from those from Your jurisdiction.</p>
        ...
        <ul class="dots">
          <li>By email: <a href="mailto:help@domainseller.com">help@domainseller.com</a>
          </li>
        </ul>
      </div>
    </div>
...
export default {
  ...
  head: {
    title: 'Privacy policy - domainseller.com',
    meta: [
      {
        name: 'description',
