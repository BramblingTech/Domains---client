      ...
      <div class="container">
        ...
        <ul class="dots">
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
            refers to Domain Seller.
          </li>
          <li><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a
            digital tablet.
          </li>
          <li><strong>Service</strong> refers to the Website.</li>
          <li><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that form
            the entire
            agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement
          ...
          <li>Website refers to Domain Seller, accessible from <a href="https://godaddy.com">www.godaddy.com</a></li>
        ...
        <ul class="dots">
          <li>By email: <a href="mailto:admin@domainseller.com">admin@domainseller.com</a></li>
        </ul>
      </div>
    </div>
  </div>
...
export default {
  ...
  head: {
    title: 'Terms and conditions - domainseller.com',
    meta: [
      {
        name: 'description',
...
@import "../assets/scss/pages/tech-page";
</style>
